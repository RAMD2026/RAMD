package it.uni.disim.architecturemodeling.launcher.validation;
...
import it.uni.disim.architecturemodeling.launcher.EpsilonStandaloneExample;
...
public class RAV_bk extends EpsilonStandaloneExample {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            ...
            System.err.println(
                ...
                "src/it/uni/disim/architecturemodeling/launcher/models/weaving/rawebbrowser-mozilla.model " +
        ...
        registerMetamodelGlobally("src/it/uni/disim/architecturemodeling/launcher/metamodels/architecturemodeling.ecore");
    ...
    public List<IModel> getModels() throws Exception {
        ...
        models.add(
            createEmfModelByURI(
                "archmm",
                "src/it/uni/disim/architecturemodeling/launcher/metamodels/architecturemodeling.ecore",
        ...
        models.add(
            createEmfModelByURI(
                "ramm",
                "src/it/uni/disim/architecturemodeling/launcher/models/referencearchitectures/iot.ecore",
                "http://www.eclipse.org/emf/2002/Ecore",
                true,
                false
            )
        ...
        models.add(
            createEmfModelByURI(
                "weaving",
                modelPath,                   
                "http://it.uni.disim/ra_adl",   // nsURI trong RA_ADL.ecore
                true,
                true
            )
        );
    ...
    public String getSource() throws Exception {
        return "src/it/uni/disim/architecturemodeling/launcher/validation/RA-ADL-validator.evl";
    }
