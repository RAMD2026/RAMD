    ...
    public static void main(String[] args) {
        try {
            ...
            Resource archMMRes = rs.getResource(
                fileURI("src/it/uni/disim/architecturemodeling/launcher/metamodels/architecturemodeling.ecore"),
                true
            );
            ...
            Resource rammRes = rs.getResource(
                fileURI("src/it/uni/disim/architecturemodeling/launcher/models/referencearchitectures/Ramm.ecore"),
                true
            );
            ...
            Resource raadlRes = rs.getResource(
                fileURI("src/it/uni/disim/architecturemodeling/launcher/metamodels/RA_ADL.ecore"),
                true
            );
            ...
            Resource archRes = rs.getResource(
                fileURI("src/it/uni/disim/architecturemodeling/launcher/models/architectures/mozilla.model"),
                true
            );
            ...
            Resource weavingRes = rs.getResource(
                fileURI("src/it/uni/disim/architecturemodeling/launcher/models/weaving/rawebbrowser-mozilla.model"),
                true
            );
