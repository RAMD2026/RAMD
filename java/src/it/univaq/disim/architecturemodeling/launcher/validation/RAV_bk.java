...
public class RAV_bk extends EpsilonStandaloneExample {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            ...
            System.err.println(
                ...
                "src/it/univaq/disim/architecturemodeling/launcher/models/weaving/rawebbrowser-mozilla.model " +
        ...
        registerMetamodelGlobally("src/it/univaq/disim/architecturemodeling/launcher/metamodels/architecturemodeling.ecore");
    ...
    public List<IModel> getModels() throws Exception {
        ...
        models.add(
            createEmfModelByURI(
                "archmm",
                "src/it/univaq/disim/architecturemodeling/launcher/metamodels/architecturemodeling.ecore",
        ...
        models.add(
            createEmfModelByURI(
                "ramm",
                "src/it/univaq/disim/architecturemodeling/launcher/models/referencearchitectures/iot.ecore",
                "http://www.eclipse.org/emf/2002/Ecore",
                true,
                false
            )
        ...
        models.add(
            createEmfModelByURI(
                "weaving",
                modelPath,                   
                "http://it.univaq.disim/ra_adl",   // nsURI trong RA_ADL.ecore
                true,
                true
            )
        );
    ...
    public String getSource() throws Exception {
        return "src/it/univaq/disim/architecturemodeling/launcher/validation/RA-ADL-validator.evl";
    }
